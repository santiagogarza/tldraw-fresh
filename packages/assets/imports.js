...
export function getAssetUrlsByImport(opts) {
	...
	return {
		...
		icons: {
			...
			'animation-jiggle': iconsIcon0MergedSvg2 + '#animation-jiggle',
			'animation-none': iconsIcon0MergedSvg2 + '#animation-none',
			'animation-pulse': iconsIcon0MergedSvg2 + '#animation-pulse',
			'animation-spin': iconsIcon0MergedSvg2 + '#animation-spin',
