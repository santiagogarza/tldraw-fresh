...
export function getAssetUrlsByMetaUrl(opts) {
	...
	return {
		...
		icons: {
			...
			'animation-jiggle': iconsIcon0MergedSvg + '#animation-jiggle',
			'animation-none': iconsIcon0MergedSvg + '#animation-none',
			'animation-pulse': iconsIcon0MergedSvg + '#animation-pulse',
			'animation-spin': iconsIcon0MergedSvg + '#animation-spin',
