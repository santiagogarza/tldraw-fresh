import { type TLNamedColorStyle } from '@tldraw/tlschema'
...
const defaultColorNames: TLNamedColorStyle[] = [
	'black',
	'grey',
	'light-violet',
	'violet',
...
const TLDRAW_PALETTE: [TLNamedColorStyle, number, number, number][] = defaultColorNames.map(
	(name) => {
