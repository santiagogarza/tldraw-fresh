...
export class GeoShapeUtil extends BaseBoxShapeUtil<TLGeoShape> {
    ...
    // (undocumented)
    getHandles(shape: TLGeoShape): TLHandle[];
    // (undocumented)
    ...
    onBeforeCreate(shape: TLGeoShape): {
        ...
        props: {
            ...
            cornerRadius: "pill" | "round" | "sharp" | "soft";
    ...
    // (undocumented)
    onHandleDrag(shape: TLGeoShape, { handle }: TLHandleDragInfo<TLGeoShape>): TLShapePartial<TLGeoShape> | void;
    // (undocumented)
    onHandleDragCancel(shape: TLGeoShape): void;
    // (undocumented)
    onHandleDragEnd(shape: TLGeoShape, { handle }: TLHandleDragInfo<TLGeoShape>): TLShapePartial<TLGeoShape> | void;
    // (undocumented)
