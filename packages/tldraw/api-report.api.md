...
// @public (undocumented)
export type CanvasThemeId = 'dark' | 'light' | 'sky' | 'sunrise' | 'sunset';

// @public (undocumented)
export const CanvasThemePicker: NamedExoticComponent<object>;
...
// @public (undocumented)
export const DEFAULT_CANVAS_THEME_ID: CanvasThemeId;
...
// @public (undocumented)
export function useCanvasTheme(): void;
