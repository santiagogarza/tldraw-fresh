...
export class GeoShapeUtil extends BaseBoxShapeUtil<TLGeoShape> {
    ...
    // (undocumented)
    onHandleDrag(shape: TLGeoShape, { handle }: TLHandleDragInfo<TLGeoShape>): void;
    // (undocumented)
    onHandleDragCancel(shape: TLGeoShape, { handle }: TLHandleDragInfo<TLGeoShape>): void;
    // (undocumented)
    onHandleDragEnd(shape: TLGeoShape, { handle }: TLHandleDragInfo<TLGeoShape>): {
        id: TLShapeId;
        props: {
            cornerRadius: "pill" | "round" | "sharp" | "soft";
        };
