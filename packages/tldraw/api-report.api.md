...
// @public
export function applyCanvasModeStyles(container: HTMLElement | null | undefined, mode: TLCanvasMode): void;
...
// @public (undocumented)
export const DEFAULT_CANVAS_MODE_ID: TLCanvasModeId;
...
// @public (undocumented)
export const DefaultModeSwitcher: NamedExoticComponent<object>;
...
// @public (undocumented)
export type TLCanvasModeId = 'dark' | 'light' | 'sky' | 'sunrise' | 'sunset';
