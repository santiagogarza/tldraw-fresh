...
// @public (undocumented)
export const StylePanelColorPicker: NamedExoticComponent<unknown>;
...
export interface StylePanelContext {
    ...
    // (undocumented)
    onColorStyleApplied(value: TLDefaultColorStyle_2): void;
    // (undocumented)
    onHistoryMark(id: string): void;
    // (undocumented)
    ...
    // (undocumented)
    recentShapeColors: TLDefaultColorStyle_2[];
    // (undocumented)
...
// @public (undocumented)
export function StylePanelContextProvider(props: StylePanelContextProviderProps): JSX.Element;
