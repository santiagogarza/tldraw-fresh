...
import {
	...
	getPreviewCornerRadiusEpoch,
	getRectangleCornerRadiusForShape,
	setPreviewCornerRadius,
	snapCornerRadiusPreview,
...
export class GeoShapeUtil extends BaseBoxShapeUtil<TLGeoShape> {
	...
	override onHandleDragEnd(shape: TLGeoShape) {
		...
		const next = snapCornerRadiusPreview(shape, preview)
	...
	component(shape: TLGeoShape) {
		...
		// Re-render during corner-radius handle drag preview
		useValue('cornerRadiusPreview', () => getPreviewCornerRadiusEpoch().get(), [editor, shape.id])
