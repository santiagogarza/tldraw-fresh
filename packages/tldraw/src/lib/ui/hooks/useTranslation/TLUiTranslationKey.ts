...
export type TLUiTranslationKey =
	...
	| 'style-panel.color'
	| 'style-panel.recent-colors'
	| 'color-style.custom'
	| 'color-style.picker-hex'
	| 'color-style.picker-r'
	| 'color-style.picker-g'
	| 'color-style.picker-b'
	| 'color-style.picker-apply'
	| 'color-style.low-contrast'
	| 'color-style.picker-error'
	| 'style-panel.dash'
	| 'style-panel.fill'
	| 'style-panel.font'
	| 'style-panel.geo'
