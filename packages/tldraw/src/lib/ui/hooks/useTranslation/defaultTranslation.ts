...
export const DEFAULT_TRANSLATION = {
	...
	'style-panel.color.custom': 'Custom color',
	'style-panel.color.recent': 'Recent',
	'custom-color-picker.hex': 'Hex',
	'custom-color-picker.r': 'R',
	'custom-color-picker.g': 'G',
	'custom-color-picker.b': 'B',
	'custom-color-picker.wheel': 'Color wheel',
	'custom-color-picker.cancel': 'Cancel',
	'custom-color-picker.invalid-hex': 'Enter a hex color like #ff00aa',
