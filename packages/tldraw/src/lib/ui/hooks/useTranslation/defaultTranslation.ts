...
export const DEFAULT_TRANSLATION = {
	...
	'style-panel.recent-colors': 'Recent',
	'color-style.custom': 'Custom',
	'color-style.picker-hex': 'Hex',
	'color-style.picker-r': 'R',
	'color-style.picker-g': 'G',
	'color-style.picker-b': 'B',
	'color-style.picker-apply': 'Apply',
	'color-style.low-contrast': 'Low contrast on this background',
	'color-style.picker-error': 'Use #RRGGBB or 0-255 in each field.',
